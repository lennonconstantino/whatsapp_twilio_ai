...
class TestQueueService(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_enqueue(self):
        ...
        msg_id = await self.service.enqueue(
            task_name, payload, correlation_id="corr_1", owner_id="owner_1"
        )
    ...
    async def test_process_message_success(self):
        ...
        message = QueueMessage(task_name="test_task", payload={"data": 123}, id="msg_1")
    ...
    async def test_process_message_no_handler(self):
        message = QueueMessage(task_name="unknown_task", payload={}, id="msg_1")
