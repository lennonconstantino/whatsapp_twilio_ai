...
class TestIdentityAtomicity(unittest.TestCase):
    def setUp(self):
        ...
        self.user_dto = UserCreateDTO(owner_id=valid_ulid, first_name="Admin", phone="1234567890")
        self.created_owner = Owner(owner_id="01ARZ3NDEKTSV4RRFFQ69G5FAV", name="Test Corp", email="test@corp.com")
    ...
    def test_register_organization_rollback_on_user_failure(self):
        ...
        self.mock_user_service.create_user.side_effect = Exception("User creation failed")
        ...
        # Verify Rollback
        self.mock_owner_service.delete_owner.assert_called_once_with(self.created_owner.owner_id)
