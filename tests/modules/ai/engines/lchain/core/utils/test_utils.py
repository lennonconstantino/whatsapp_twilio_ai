...
from src.modules.ai.engines.lchain.core.utils.utils import (
    parse_function_args,
    get_tool_from_response,
    run_tool_from_response,
    weekday_by_date,
    date_to_string,
    parse_date,
    pydantic_model_to_string,
    generate_query_context,
    convert_to_langchain_tool,
    convert_pydantic_to_openai_function,
    convert_langchain_to_openai_tool
)
...
class TestUtils:
    ...
    def test_convert_to_langchain_tool(self):
        ...
        tool = convert_to_langchain_tool(Args, name="MyTool", description="My Description")
