...
class TestFeatureRepository:
    ...
    def test_find_by_owner(self, repository, mock_query_builder, mock_feature_data):
        ...
        mock_query_builder.eq.assert_called_with("owner_id", "01ARZ3NDEKTSV4RRFFQ69G5FAV")
        mock_query_builder.limit.assert_called_with(100)

    def test_find_enabled_by_owner(self, repository, mock_query_builder, mock_feature_data):
    ...
    def test_find_by_name(self, repository, mock_query_builder, mock_feature_data):
        ...
        result = repository.find_by_name("01ARZ3NDEKTSV4RRFFQ69G5FAV", "whatsapp_integration")
