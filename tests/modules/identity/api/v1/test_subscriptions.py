...
class TestSubscriptionsAPI:
    ...
    def test_get_owner_subscription_success(
        ...
        result = get_owner_subscription(
            owner_id="01ARZ3NDEKTSV4RRFFQ69G5FAV",
            authenticated_owner_id="01ARZ3NDEKTSV4RRFFQ69G5FAV",
            subscription_service=mock_subscription_service,
        )
    ...
    def test_create_subscription_success(
        self, mock_subscription_service, mock_user, mock_subscription
    ):
    ...
    def test_create_subscription_forbidden_owner(
        self, mock_subscription_service, mock_user
    ):
    ...
    def test_cancel_subscription_success(
        ...
        assert result == mock_subscription
        mock_subscription_service.cancel_subscription.assert_called_with(
            "sub_123", "01ARZ3NDEKTSV4RRFFQ69G5FAV"
        )
    ...
    def test_cancel_subscription_idor(self, mock_subscription_service):
        """
        Test cancelling subscription of another user (IDOR prevention).
        
        The service/repository should return None if the subscription_id
        does not belong to the owner_id provided.
        """
        mock_subscription_service.cancel_subscription.return_value = None
