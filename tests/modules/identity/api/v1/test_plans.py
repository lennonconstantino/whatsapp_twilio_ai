...
from src.modules.identity.api.v1.plans import (create_plan, get_plan,
...
class TestPlansAPI:
    ...
    def test_create_plan(self, mock_plan_service, mock_plan):
        ...
        plan_create = PlanCreate(
            name="Basic Plan", display_name="Basic Plan", code="basic", price=10.0
        )
    ...
    def test_update_plan_success(self, mock_plan_service, mock_plan):
        ...
        result = update_plan(
            plan_id="plan_123", plan_data=plan_update, plan_service=mock_plan_service
        )
