...
from src.modules.identity.models.subscription import Subscription, SubscriptionCreate, SubscriptionUpdate
...
class TestSubscriptionService(unittest.TestCase):
    ...
    def test_create_subscription_success(self):
        ...
        self.mock_plan_repo.find_by_id.assert_called_with(self.plan_id, id_column="plan_id")
        self.mock_subscription_repo.find_active_by_owner.assert_called_with(self.owner_id)
    ...
    def test_create_subscription_cancels_existing(self):
        ...
        self.mock_subscription_repo.cancel_subscription.assert_called_with(existing_sub_id)
        self.mock_subscription_repo.create.assert_called()
        self.assertEqual(result, expected_subscription)
