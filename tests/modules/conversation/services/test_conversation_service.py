...
class TestConversationService:
    ...
    def test_get_or_create_expired_creates_new(self, service, mock_repo, mock_conversation):
        ...
        assert call_args["metadata"]["previous_conversation_id"] == mock_conversation.conv_id
    ...
    def test_add_message_reactivates_idle(self, service, mock_repo, mock_message_repo, mock_conversation):
    ...
    def test_add_message_agent_accepts_pending(self, service, mock_repo, mock_message_repo, mock_conversation):
    ...
    def test_add_message_user_pending_keeps_pending(self, service, mock_repo, mock_message_repo, mock_conversation, mock_closure_detector):
    ...
    def test_add_message_cancellation_in_pending(self, service, mock_repo, mock_message_repo, mock_conversation, mock_closure_detector):
    ...
    def test_add_message_concurrency_retry(self, service, mock_repo, mock_message_repo, mock_conversation):
    ...
    def test_close_conversation_concurrency_retry(self, service, mock_repo, mock_conversation):
    ...
    def test_get_methods(self, service, mock_repo, mock_message_repo, mock_conversation):
        ...
        # Execute & Verify
        assert service.get_conversation_by_id("01ARZ3NDEKTSV4RRFFQ69G5FAV") == mock_conversation
        assert service.get_active_conversations("01ARZ3NDEKTSV4RRFFQ69G5FAV") == [mock_conversation]
    ...
    def test_process_expired_concurrency_recovery(self, service, mock_repo, mock_conversation):
    ...
    def test_add_message_duplicate_error(self, service, mock_repo, mock_message_repo, mock_conversation):
    ...
    def test_process_idle_concurrency_recovery(self, service, mock_repo, mock_conversation):
    ...
    def test_transfer_conversation(self, service, mock_repo, mock_conversation):
        ...
        assert call_args[0][1]["context"]["transfer_history"][0]["reason"] == "shift_change"
    ...
    def test_extend_expiration(self, service, mock_repo, mock_conversation):
        ...
        # Verify
        assert result == mock_conversation
        mock_repo.extend_expiration.assert_called_with(
            mock_conversation.conv_id,
            60
        )

    def test_check_closure_intent_auto_close(self, service, mock_repo, mock_conversation, mock_closure_detector, mock_message_repo):
    ...
    def test_add_message_concurrency_context_update(self, service, mock_repo, mock_message_repo, mock_conversation):
    ...
    def test_get_or_create_background_tasks_disabled(self, service, mock_repo, mock_conversation):
        ...
        # Mock settings
        with patch("src.modules.conversation.services.conversation_service.settings") as mock_settings:
    ...
    def test_get_or_create_expired_not_closed(self, service, mock_repo, mock_conversation):
    ...
    def test_get_or_create_link_previous(self, service, mock_repo, mock_conversation):
        ...
        assert call_args["metadata"]["previous_status"] == ConversationStatus.FAILED.value
        assert call_args["metadata"]["recovery_mode"] is True

    def test_add_message_max_retries_exceeded(self, service, mock_repo, mock_message_repo, mock_conversation):
    ...
    def test_add_message_critical_error(self, service, mock_repo, mock_message_repo, mock_conversation):
