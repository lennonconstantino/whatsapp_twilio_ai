...
class TestConversationRepository:
    ...
    def test_find_by_session_key(self, repository, mock_client, mock_conversation_data):
        ...
        mock_client.table.return_value.select.return_value \
            .eq.return_value.eq.return_value.in_.return_value \
            .limit.return_value.execute.return_value.data = [mock_conversation_data]
    ...
    def test_find_active_by_owner(self, repository, mock_client, mock_conversation_data):
        """Test finding active conversation by owner."""
        mock_client.table.return_value.select.return_value \
            .eq.return_value.in_.return_value.order.return_value \
            .limit.return_value.execute.return_value.data = [mock_conversation_data]
    ...
    def test_find_all_by_session_key(self, repository, mock_client, mock_conversation_data):
    ...
    def test_create_exception_handling(self, repository, mock_client, mock_conversation_data):
        ...
        with patch("src.modules.conversation.repositories.conversation_repository.logger") as mock_logger:
            ...
            mock_conv_table.insert.return_value.execute.return_value.data = [mock_conversation_data]
            
            mock_hist_table = MagicMock()
            mock_hist_table.insert.return_value.execute.side_effect = Exception("DB Error")
    ...
    def test_update_status_generic_exception(self, repository, mock_client, mock_conversation_data):
    ...
    def test_update_status_update_failed_return_none(self, repository, mock_client, mock_conversation_data):
    ...
    def test_update_concurrency_error_propagation(self, repository, mock_client, mock_conversation_data):
    ...
    def test_create_history_write_exception(self, repository, mock_client, mock_conversation_data):
        ...
        mock_conv_table = MagicMock()
        # Select
        mock_conv_table.select.return_value.eq.return_value.execute.return_value.data = [mock_conversation_data]
        # Update
        mock_conv_table.update.return_value.eq.return_value.eq.return_value.execute.return_value.data = [updated_data]
