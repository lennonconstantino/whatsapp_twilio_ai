...
class TestTwilioService:
    ...
    async def test_get_client_default_dev(self, service, mock_repo, mock_twilio_client):
    ...
    async def test_get_client_no_account(self, service, mock_repo):
    ...
    async def test_send_message_success(self, service, mock_twilio_client):
    ...
    async def test_send_message_fake_sender(self, service):
    ...
    async def test_send_message_error(self, service, mock_twilio_client):
    ...
    async def test_get_message_status_success(self, service, mock_twilio_client):
        ...
        result = await service.get_message_status(owner_id, "SM123")
    ...
    def test_validate_webhook_signature(self, service):
        ...
        # This method is sync, so no await
    ...
    async def test_send_message_split_chunks(self, service, mock_twilio_client):
