...
def test_complete_conversation_lifecycle():
    ...
    # add_message might call update_status if transition happens, but here it shouldn't for PENDING->PENDING
    # actually add_message logic for USER message in PENDING doesn't change status unless configured.
