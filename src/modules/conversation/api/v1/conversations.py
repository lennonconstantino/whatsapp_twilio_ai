...
async def close_conversation(
    ...
    try:
        ...
        closed = service.close_conversation_with_priority(
            conversation, status, initiated_by="api_user", reason=reason
        )
...
async def transfer_conversation(
    ...
    try:
        transferred = service.transfer_conversation(
            conversation, transfer_data.new_user_id, transfer_data.reason
        )
...
async def escalate_conversation(
    ...
    try:
        escalated = service.escalate_conversation(
            conversation, escalation_data.supervisor_id, escalation_data.reason
        )
