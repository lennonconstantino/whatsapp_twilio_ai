...
class ConversationServiceV2:
    ...
    def get_or_create_conversation(
        ...
        if conversation:
            ...
            is_closed = conversation.is_closed() # Should generally be false here given find_active logic
    ...
    def _update_acceptance_context(self, conversation: Conversation, message_create: MessageCreateDTO):
