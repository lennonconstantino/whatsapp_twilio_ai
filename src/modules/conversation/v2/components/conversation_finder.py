...
class ConversationFinder:
    ...
    def find_last_conversation(
        ...
        """
        session_key = self.calculate_session_key(from_number, to_number)
        conversations = self.repository.find_all_by_session_key(owner_id, session_key, limit=1)
    ...
    def create_new(
        ...
        if previous_conversation:
             new_metadata.update({
                 ...
                 "previous_ended_at": previous_conversation.ended_at.isoformat() if previous_conversation.ended_at else None,
