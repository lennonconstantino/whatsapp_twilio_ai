...
class InvoiceRepository(BaseRepository[Invoice]):
    ...
    def get_all_with_customers(
        ...
        try:
            ...
            logger.error(
                f"Error finding all invoices with customers",
                error=str(e)
            )
            raise
...
_revenue_repo: Optional[RevenueRepository] = None
_expense_repo: Optional[ExpenseRepository] = None
_customer_repo: Optional[CustomerRepository] = None
_invoice_repo: Optional[InvoiceRepository] = None


def get_revenue_repository() -> RevenueRepository:
    """Retorna instância singleton do RevenueRepository"""
    global _revenue_repo
    if _revenue_repo is None:
        _revenue_repo = RevenueRepository()
    return _revenue_repo


def get_expense_repository() -> ExpenseRepository:
    """Retorna instância singleton do ExpenseRepository"""
    global _expense_repo
    if _expense_repo is None:
        _expense_repo = ExpenseRepository()
    return _expense_repo


def get_customer_repository() -> CustomerRepository:
    """Retorna instância singleton do CustomerRepository"""
...
def get_invoice_repository() -> InvoiceRepository:
    """Retorna instância singleton do InvoiceRepository"""
