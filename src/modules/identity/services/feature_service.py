...
class FeatureService:
    ...
    def create_feature(self, data: FeatureCreateDTO) -> Optional[Feature]:
        ...
        if existing:
            logger.warning(f"Feature '{data.name}' already exists for owner {data.owner_id}")
    ...
    def update_configuration(self, feature_id: int, config: Dict[str, Any]) -> Optional[Feature]:
        """
