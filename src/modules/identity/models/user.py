...
class UserSync(BaseModel):
    ...
    external_auth_id: str = Field(..., description="Sub or ID from external auth provider")
    email: EmailStr
    first_name: Optional[str] = None
    last_name: Optional[str] = None
    profile_name: Optional[str] = None
...
class User(UserBase):
    ...
    auth_id: Optional[str] = None  # External auth ID (e.g., sub from JWT or external auth ID)
    active: bool = True
